...
import {PageProps, PaginationResource} from '@/types';
import {NotificationOutlined, HomeOutlined} from '@ant-design/icons';
import "@/../scss/Component/Nav.scss"

interface ClientCompanyItemResource {
    id: string;
    operation_classification: SystemOperationClassification;
    name: string;
    date_start: Date;
    date_end: Date;
    client_users: {
...
interface ClientCompanyCollection extends PaginationResource<ClientCompanyItemResource>{

}

export default function Index({ auth }: PageProps<ClientCompanyCollection>) {
    return (
        <AuthenticatedLayout
            user={auth.user}
            buttons={
